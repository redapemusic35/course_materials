...
\fancyhead[RO,LE]{\textbf{\shorttitle}} % Right Odd, Left Even
\fancyfoot[C]{\thepage} % Center footer for page number
\renewcommand{\headrulewidth}{0pt} % Remove header rule

% Define plain style for chapter pages
...
% Command to set the short title
\newcommand{\shorttitle}{} % Initialize with an empty default
\newcommand{\setchaptershorttitle}[1]{\renewcommand{\shorttitle}{#1}}
