...
title: "Luck and Ethics"
author: Montaque F. Reynolds
date: "Spring 2025"
...
not_here_dates <- c(
  ...
  ymd(20250207),
  # Spring Break
  seq(ymd(20250315),ymd(20250319), by=1))
...
tibble(date = seq(ymd(20250101), ymd(20250530), by=1))  %>%
...
```{r calendar, echo=F, eval=T, fig.cap="A Calendar for the Class (Luck and Ethics, Spring 2025)",  warning=F, fig.width=11, fig.height=7}
...
*No class Thursday (Philosophers usually have a conference to start the semester).*
...
Read *all* associated documents on course website.
  ...
  - [How to write a philosophy paper](http://www.jimpryor.net/teaching/guidelines/writing.html)
  - [How to write a philosophy paper in four sentences](https://philpapers.org/archive/EARTFP.pdf)


## `r advdate(mon, 2)`: The good life.

* Virtue and Human Excellence
* Virtue and Irrational Attachments

##  `r advdate(mon, 3)`: Emotion and rationality.

2. `r Citet(bib, "lesk66")`
3. Self-Sufficiency: Irrational appetites, rationality

##  `r advdate(mon, 4)`:  Tragic Literature

1. Practical conflict and the Euthyphro
