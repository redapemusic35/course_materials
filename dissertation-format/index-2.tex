...
\acknowledgements
\begin{abstract}
\textbf{Purpose}: The abstract serves both as a general introduction to
...
The Introduction section, of referenced text Campbell and Gear (1995)
expands on the background of the work (some overlap with the Abstract is
...
\begin{figure}
\includegraphics{index_files/figure-latex/fig1-1} \caption{This is an example of a caption}\label{fig:fig1}
\end{figure}
...
For citations of references, use~Campbell and Gear (1995) or (Slifka and
Whitton 2000).
...
Campbell, S. L., and C. W. Gear. 1995. ``The Index of General Nonlinear
DAES.'' \emph{Numer. Math.} 72 (2): 173--96.

\leavevmode\hypertarget{ref-bib2}{}%
Slifka, M. K., and J. L. Whitton. 2000. ``Clinical Implications of
Dysregulated Cytokine Production.'' \emph{J. Mol. Med.} 78: 74--80.
