...
::: {.remark}
Nixon wears a silk top hat.
:::

::: {.remark}
Holmes wears a silk top-hat.
:::

If we could, then each would be false. Instead however, Kyle Blumberg and Ben Holguin argue that each is true while David Lewis says they are undetermined simpliciter, but true or false with an implied prefix operator.
